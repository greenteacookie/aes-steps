<?php
function subBytes($s, $Nb = 4)
    {
        $sBox = array(
        0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5, 0x30, 0x01, 0x67, 0x2b, 0xfe, 0xd7, 0xab, 0x76, //16 per row
...
foreach ($processedArray['ar'] as $key => $value) {
    ...
    $mixedArray = subBytes($processedArray['ar']);
